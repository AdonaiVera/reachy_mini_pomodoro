"""Audio-driven head movement generation for realistic talking animation.

Based on the Reachy Mini conversation app's implementation.
Converts audio samples into head sway/wobble movements.
"""
...
class SwayRollRT:
    """Feed audio chunks -> per-hop sway outputs for realistic talking animation.
